			...
			<div class="box">
					<div class="box-header with-border">
						...
						<div class="box-tools pull-right">
							...
							<a href="{{ route('dashboard.gallery.create') }}" class="btn btn-primary">+ Tambah</a>
						</div>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
							...
							<tbody>
								@foreach ($gallery as $item)
									<tr>
										...
										<td>
											<a href="{{ route('dashboard.gallery.delete', \Crypt::encrypt($item->id)) }}" onclick="return confirm('Apakah anda yakin?')">
